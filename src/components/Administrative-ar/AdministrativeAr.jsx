...
import admin6 from '../../images/admin-6.jpg'
...
import './style/administrativeAr.css'
import HeaderAr from '../header-ar/HeaderAr';

function AdministrativeAr() {
  return (
    <>
    <HeaderAr/>
    <section className='administrative-ar'>
    {/* start heading */}
...
export default AdministrativeAr