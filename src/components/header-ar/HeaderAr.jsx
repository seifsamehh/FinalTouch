    ...
    <header className='header-ar'>
        <Container className='container'>
            <Row className='row'>
                <Col className="pages">
                    <nav>
                        <Link to="/HomeAr" className='underline'>الصفحة الرئيسية</Link>
                        <Link to="/aboutAr" className='underline'>خدماتنا</Link>
                        <Link to="/workAr" className='underline'>من اعمالنا</Link>
                        <Link to="/ContactAr" className='underline'>للتواصل معنا</Link>
                        <Link to="/" className='underline'>انجليزى</Link>
                    </nav>
                </Col>
                {/* media */}
